              ...
              <div className="flex items-center gap-4">
                <Link href={project.live}>
                  <TooltipProvider delayDuration={100}>
                    <Tooltip>
                      <TooltipTrigger className="w-[70px] h-[44px] rounded-lg bg-white/5 flex justify-center items-center group hover:bg-accent transition-all">
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              <WorkSliderBtns
                ...
                btnStyles="bg-accent hover:bg-accent-hover text-primary text-[22px] w-[70px] h-[44px] rounded-lg flex justify-center items-center transition-all"
              />
            </Swiper>
          </div>
        </div>
